...
export class OAuth2APIApi extends runtime.BaseAPI {
    ...
    async getTokenRaw(requestParameters: GetTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuthTokenResponse>> {
        ...
        if (requestParameters['requestedTokenType'] != null) {
            formParams.append('requested_token_type', new Blob([JSON.stringify(TokenTypeToJSON(requestParameters['requestedTokenType']))], { type: "application/json", }));
                    }
        ...
        if (requestParameters['subjectTokenType'] != null) {
            formParams.append('subject_token_type', new Blob([JSON.stringify(TokenTypeToJSON(requestParameters['subjectTokenType']))], { type: "application/json", }));
                    }
        ...
        if (requestParameters['actorTokenType'] != null) {
            formParams.append('actor_token_type', new Blob([JSON.stringify(TokenTypeToJSON(requestParameters['actorTokenType']))], { type: "application/json", }));
                    }
