 ...
 */
export function instanceOfRemoveStatisticsUpdate(value: object): value is RemoveStatisticsUpdate {
...
export function RemoveStatisticsUpdateToJSON(json: any): RemoveStatisticsUpdate {
    return RemoveStatisticsUpdateToJSONTyped(json, false);
}

export function RemoveStatisticsUpdateToJSONTyped(value?: RemoveStatisticsUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
