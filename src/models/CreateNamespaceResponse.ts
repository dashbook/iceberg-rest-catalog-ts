 ...
 */
export function instanceOfCreateNamespaceResponse(value: object): boolean {
...
export function CreateNamespaceResponseToJSON(value?: CreateNamespaceResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
