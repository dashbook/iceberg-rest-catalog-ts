 ...
 * @export
 */
export const DataFileContentEnum = {
    Data: 'data'
} as const;
export type DataFileContentEnum = typeof DataFileContentEnum[keyof typeof DataFileContentEnum];
