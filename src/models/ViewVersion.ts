 ...
 */
export function instanceOfViewVersion(value: object): boolean {
    ...
    if (!('representations' in value)) return false;
    if (!('defaultNamespace' in value)) return false;
    return true;
}
...
export function ViewVersionToJSON(value?: ViewVersion | null): any {
    if (value == null) {
        return value;
    }
    return {
