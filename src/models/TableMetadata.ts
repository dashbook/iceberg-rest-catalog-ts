...
export interface TableMetadata {
     ...
     * @memberof TableMetadata
     */
    partitionStatisticsFiles?: Array<PartitionStatisticsFile>;
}
...
export function TableMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): TableMetadata {
    ...
    return {
        ...
        'statisticsFiles': json['statistics-files'] == null ? undefined : ((json['statistics-files'] as Array<any>).map(StatisticsFileFromJSON)),
        'partitionStatisticsFiles': json['partition-statistics-files'] == null ? undefined : ((json['partition-statistics-files'] as Array<any>).map(PartitionStatisticsFileFromJSON)),
    };
}
...
export function TableMetadataToJSON(value?: TableMetadata | null): any {
    ...
    return {
        ...
        'statistics-files': value['statisticsFiles'] == null ? undefined : ((value['statisticsFiles'] as Array<any>).map(StatisticsFileToJSON)),
        'partition-statistics-files': value['partitionStatisticsFiles'] == null ? undefined : ((value['partitionStatisticsFiles'] as Array<any>).map(PartitionStatisticsFileToJSON)),
    };
}
